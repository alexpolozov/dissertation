...
\lstdefinelanguage{dsl}{
    morekeywords = {language,feature,using,semantics,learners,int,string,@input,@start,values,let,in,@ref,@values,Tuple,@extern,@output,namespace,bool},
    otherkeywords = {: = ,|,;, = >,:,[,]},
    sensitive = true,
    morecomment = [l]{//},
    morestring = [b]',
...
\DeclareMathOperator*{\bigvsaunion}{\adjustbox{scale=1.6, valign=t}{$\bm{\mathsf{U}}$}}
