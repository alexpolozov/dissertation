...
\end{theorem}
% \vspace{-\baselineskip}
% \noindent In~\Cref{sec:topdown}, I show another application of the clustering operation, where it helps us to partition the search space of
...
\todoinline{Representation of VSA as a DSL}
