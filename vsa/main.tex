...
\begin{figure}[t]
    \centering
    \begin{dot2tex}[dot, tikz, options=-ftikz -tmath -c --autosize --usepdflatex --figonly]
...
\subseteq \dsl$.
% For instance, if $N = \start{\dsl}$, then the VSA $\vsa = \dsl|_{N}$ is isomorphic to the CFG of $\dsl$.
